                    ...
                    success: function (html) {
                        if (html == 'true') {
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Full Name</strong> must cannot exceed 40 characters. \ \
                                                 </div>');
                            ...
                            $("#add_err2").html('<div class="alert alert-danger"> \
                                                 <strong>Message</strong> must cannot exceed 150 characters. \ \
                                                 </div>');
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    <p>Phone:
                        <strong>+2347086401433</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:name@example.com">adetunjiadeynka29@gmail.com</a></strong>
                    </p>
                    <p>Address:
                    ...
                    <form role="form">
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" id="fname" name="fname" class="form-control" maxlength="40">
                            </div>
                            <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12">
                                <label>Message</label>
                                <textarea class="form-control" id="messgae" name="messgae" rows="6" maxlength="150"></textarea>
                            </div>
                            <div class="form-group col-lg-12">
