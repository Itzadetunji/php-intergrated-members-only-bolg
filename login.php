...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <div class="alert alert-danger"><strong>You Must Be Logged In To View This Blog.</strong></div>
                    <hr>
                    ...
                    <div class="form-group col-lg-12">
                        <a href="register.php"><button type="submit" id="login" class="btn btn-default">Register</button></a>
                    </div>
                </div>
            </div>
        </div>
